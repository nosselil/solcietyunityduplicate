...
namespace CMF
{
    ...
    public class CameraMouseInput : CameraInput
    {
        ...
        public override float GetHorizontalCameraInput()
        {
            ...
            {
                UpdateTouchInput();
                // Return the x delta scaled by sensitivity.
                return (isTouching ? Input.GetTouch(0).deltaPosition.x : 0f) * touchSensitivity;
            }
            else
            {
        ...
        public override float GetVerticalCameraInput()
        {
            ...
            {
                UpdateTouchInput();
                // Return the y delta scaled by sensitivity.
                return (isTouching ? Input.GetTouch(0).deltaPosition.y : 0f) * touchSensitivity;
            }
            else
            {
