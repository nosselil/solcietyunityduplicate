    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            VaryingsParticle vert(AttributesParticle input)
            {
                ...
                output.clipPos = TransformObjectToHClip((input.positionOS - GetCurveOffset(vertexInput.positionWS)).xyz);
        ...
        Pass
        {
            ...
            VaryingsDepthOnlyParticle vert(AttributesDepthOnlyParticle input)
            {
                ...
                output.clipPos = TransformObjectToHClip((input.vertex - GetCurveOffset(vertexInput.positionWS)).xyz);
