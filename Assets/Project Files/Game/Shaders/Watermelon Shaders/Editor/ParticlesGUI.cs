...
namespace Watermelon.Shader
{
    internal class ParticlesGUI : BaseShaderGUI
    {
        ...
        void CacheRenderersUsingThisMaterial(Material material)
        {
            ...
            ParticleSystemRenderer[] renderers = UnityEngine.Object.FindObjectsByType<ParticleSystemRenderer>(FindObjectsInactive.Include, FindObjectsSortMode.None) as ParticleSystemRenderer[];
