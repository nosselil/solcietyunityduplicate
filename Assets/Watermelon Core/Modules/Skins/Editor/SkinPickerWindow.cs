...
namespace Watermelon
{
    public class SkinPickerWindow : EditorWindow
    {
        ...
        private void DrawElement(Rect rect, ISkinData skinData, UnityEngine.Object previewObject, int index)
        {
        ...
        private class HandlerData
        {
            ...
            public class Tab
            {
                ...
                public UnityEngine.Object GetPreview(object value)
                {
                    object preview = previewFieldInfo.GetValue(value);
                    if (preview != null)
                    {
                        return preview as UnityEngine.Object;
                    }
