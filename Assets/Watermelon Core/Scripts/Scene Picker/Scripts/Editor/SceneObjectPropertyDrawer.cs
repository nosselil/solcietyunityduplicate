...
namespace Watermelon
{
    ...
    public class SceneObjectPropertyDrawer : UnityEditor.PropertyDrawer
    {
        ...
        private void ActivateScene(UnityEngine.Object sceneObject)
        {
        ...
        private void AddNewScene(UnityEngine.Object sceneObject)
        {
            if (sceneObject == null) return;
        ...
        private int ValidateScene(UnityEngine.Object sceneObject)
        {
            if (sceneObject == null)
            {
                return ERROR_NULL;
