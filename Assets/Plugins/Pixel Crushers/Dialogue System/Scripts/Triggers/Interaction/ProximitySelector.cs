...
namespace PixelCrushers.DialogueSystem
{
    ...
    public class ProximitySelector : MonoBehaviour
    {
        ...
        public virtual void SetCurrentUsable(Usable usable)
        {
            ...
            //    if (WalletManager.instance. interactButton != null) interactButton.gameObject.SetActive(false);
            }
        ...
        public void FuncOne()
        {
            ...
            Debug.LogError("FuncOne");
        }
        public void FuncTwo()
        {
            Debug.LogError("FuncTwo");
        }
        public void FuncThree()
        {
            Debug.LogError("FuncThree");
        }
