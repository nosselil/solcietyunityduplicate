...
namespace Privy
{
    internal static class PrivyLinkedAccountExtensions
    {
        ...
        public static PrivyEmbeddedWalletAccount EmbeddedWalletByIndexOrNull(this PrivyLinkedAccount[] accounts, int hdWalletIndex)
        {
            return accounts
                .OfType<PrivyEmbeddedWalletAccount>()
        ...
        /// </summary>
        public static PrivyEmbeddedSolanaWalletAccount[] EmbeddedSolanaWalletAccounts(this PrivyLinkedAccount[] accounts)
        {
            return accounts
                .OfType<PrivyEmbeddedSolanaWalletAccount>()
                .ToArray();
        ...
        public static PrivyEmbeddedWalletAccount EmbeddedWalletWithGreatestWalletIndexOrNull(this PrivyLinkedAccount[] accounts)
        {
            return accounts
                .OfType<PrivyEmbeddedWalletAccount>()
