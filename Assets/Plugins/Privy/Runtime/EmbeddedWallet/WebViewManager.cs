...
namespace Privy
{
    internal class WebViewManager
    {
        ...
        private async Task<IframeResponse> SendRequest<T>(IframeRequest<T> request, double seconds = 30)
        {
            ...
            switch (baseResponse.Event)
            {
                ...
                case PrivyEventType.CreateEthereumWallet:
                    return JsonConvert.DeserializeObject<IframeResponseSuccess<CreateEthereumWalletResponseData>>(responseString);

                case PrivyEventType.CreateSolanaWallet:
                    return JsonConvert.DeserializeObject<IframeResponseSuccess<CreateSolanaWalletResponseData>>(responseString);
        ...
        internal async Task<IframeResponse> Request(string accessToken, WalletEntropy walletEntropy, ChainType chainType, int hdWalletIndex, RpcRequestData.IRpcRequestDetails request)
        {
