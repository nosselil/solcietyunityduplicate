...
namespace Privy
{
    ...
    public class CreateAdditionalWalletRequestData
    {
        ...
        [JsonProperty("chainType")] public ChainType ChainType;

        [JsonProperty("entropyId")] public string EntropyId;

        [JsonProperty("entropyIdVerifier")] public EntropyIdVerifierName EntropyIdVerifier;

        [JsonProperty("hdWalletIndex")] public int WalletIndex;
    }
    ...
    public class RpcRequestData
    {
        ...
        [JsonProperty("request")] public IRpcRequestDetails Request;
        ...
        public class SolanaRpcRequestDetails: IRpcRequestDetails
        {
            ...
            [JsonProperty("params")] public SolanaSignMessageRpcRequestParams Params;
        }
    ...
    public class CreateAdditionalWalletResponseData
    {
        ...
        [JsonProperty("hdWalletIndex")] public string WalletIndex { get; set; }
    }

    public class ConnectWalletResponseData
    {
        [JsonProperty("entropyId")] public string EntropyId { get; set; }
    }
    ...
    public class RpcResponseData
    {
        ...
        public class SolanaRpcResponseDetails : IRpcResponseDetails
        {
            ...
            [JsonProperty("data")] public SolanaSignMessageRpcResponseData Data;
        }
